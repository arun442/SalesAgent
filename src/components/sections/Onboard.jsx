      ...
      <div className="bg-white rounded-2xl p-8 shadow-2xl border border-gray-200 max-w-md mx-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Please wait while we are creating your organization{dots}
          </p>
          ...
          <div className="space-y-2 text-sm text-gray-500">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <span>Configuring AI settings</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
...
export default function OrganizationDashboard() {
  ...
  const [currentStep, setCurrentStep] = useState(1);
  const [isLoading, setLoading] = useState(false);
  const [isCompletionLoading, setIsCompletionLoading] = useState(false); // New state for completion loading
  const [organizations, setOrganizations] = useState([]);
  const {
    formData,
    completeOnboarding,
 ...
 const handleComplete = async () => {
  setIsCompletionLoading(true); // Start completion loading
  ...
  try {
    ...
    setIsCompletionLoading(false); // End completion loading
  }
};
